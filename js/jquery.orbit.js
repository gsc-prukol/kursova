(function($) {
    $.fn.orbit = function(options) {
        var defaults = {  
            ...
            advanceSpeed: 40, //if auto advance is enabled, time between transitions 
            startClockOnMouseOut: true, //if clock should start on MouseOut
            startClockOnMouseOutAfter: 300, //how long after mouseout timer should start again
        ...
        return this.each(function() {
            ...
            if(options.timer) {         	
                ...
                var timerRunning;
                if(timer.length != 0) {
                    var speed = (options.advanceSpeed)/1;
